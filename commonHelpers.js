import"./assets/styles-7e73a5cd.js";import{a as l}from"./assets/vendor-0a7943b3.js";const v=document.querySelector(".favorites-quote-day-title"),f=l.create({baseURL:"https://energyflow.b.goit.study/api"});f.get("/quote ").then(e=>{v.insertAdjacentHTML("beforeend",` <p class="favorites-quote-day-text">
                ${e.data.quote}
                </p>
