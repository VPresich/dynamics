import"./assets/styles-43b8db46.js";import{a as l}from"./assets/vendor-0a7943b3.js";const u=document.querySelector(".favorites-quote-day-title"),v=l.create({baseURL:"https://energyflow.b.goit.study/api"});v.get("/quote ").then(e=>{u.insertAdjacentHTML("beforeend",` <p class="favorites-quote-day-text">
                ${e.data.quote}
                </p>
