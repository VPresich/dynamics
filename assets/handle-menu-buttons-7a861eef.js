var T=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var B=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),R=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},D=(e,t,s,a)=>(T(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s);var d=(e,t,s)=>(T(e,t,"access private method"),s);import{i as H}from"./vendor-32231325.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const O="https://energyflow.b.goit.study/api/";var y,i,m;class q{constructor(t){R(this,i);R(this,y,"");D(this,y,t)}async objectGetRequest(t){return d(this,i,m).call(this,t)}async objectCreateRequest(t,s){return d(this,i,m).call(this,t,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(t,s){return d(this,i,m).call(this,`${t}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(t,s){return d(this,i,m).call(this,`${t}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectPatchRequest(t,s){const{id:a,...n}=s;return d(this,i,m).call(this,`${t}/${a}/rating`,{method:"PATCH",body:JSON.stringify(n),headers:{"Content-Type":"application/json"}})}}y=new WeakMap,i=new WeakSet,m=async function(t,s={}){try{const a=await fetch(B(this,y)+t,s);if(!a.ok)throw new Error(`HTTP error, status: ${a.status}`);return a.json()}catch(a){console.log(a.message)}};const ce=document.querySelector(".js-quote"),F="quote",j="date",ie=new q(O);le();async function le(){try{const{quote:e,author:t}=await ue();me({quote:e,author:t})}catch(e){console.error("Error fetching or displaying quote:",e)}}async function ue(){const e=localStorage.getItem(j),t=localStorage.getItem(F),a=new Date().toISOString().split("T")[0];if(e===a&&t){const r=JSON.parse(t);if(r.quote&&r.author)return r}const n=await de();return localStorage.setItem(j,a),localStorage.setItem(F,JSON.stringify(n)),n}async function de(){const{quote:e,author:t}=await ie.objectGetRequest("quote");return{quote:e,author:t}}function me({quote:e,author:t}){ce.innerHTML=`
  ...
  `}const o="/dynamics/assets/symbols-4ad092cf.svg";function rt(e=[],t){return e.reduce((s,{_id:a,bodyPart:n,equipment:r,time:c,target:p,burnedCalories:f,gifUrl:L,name:g,filter:M,popularity:N,rating:oe})=>s+`
      ...
      </svg>`;e.insertAdjacentHTML("beforeend",s)},$e="exercises",we=".rating-form-send-btn",Ae=".close-rating-form-btn",ke=".stars-container",Oe=".star-btn.rating-form-btn",qe=".rating-form-email-input",Ie=".rating-form-comment";function _e(e={}){return`
  ...
  <form class="give-rating-form">
    ...
    <button class="rating-form-send-btn">Send</button>
      ...
      `}const Me=(e,t)=>{const s=_e(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)};function Ne(e={}){const{exerciseRating:t}=e;return`
  ...
  >
    ...
    >
      ...
      `}const W=(e,t)=>{const s=Ne(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)};async function Be(e){const t=new q(O);try{return await t.objectPatchRequest($e,e)}catch(s){throw s}}const De="/dynamics/assets/bi-x-octagon-73f29380.svg",Fe="/dynamics/assets/bi_check-45de7d45.svg";function x(e){H.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#fc5a5a",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${De}`,iconColor:"#fafafb"})}function je(e){H.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#82C43C",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${Fe}`,iconColor:"#fafafb"})}let k,$,E,S,I,u=0,v,Z=document.querySelector("."+J);function Pe(e,t){e.preventDefault(),t&&(I=t,Me({exerciseRating:u},Z),k=document.querySelector(ke),W({exerciseRating:u},k),Ue())}function Ue(){$=document.querySelector(we),$&&$.addEventListener("click",Ke),E=document.querySelector(qe),E&&E.addEventListener("input",He),S=document.querySelector(Ie),S&&S.addEventListener("input",Je);const e=document.querySelector(Ae);e&&e.addEventListener("click",ee),X()}function Ge(e){u=e.getAttribute("data-starnumber"),W({exerciseRating:u},k),X()}function X(){const e=document.querySelectorAll(Oe);e&&e.forEach(function(t){t.addEventListener("click",()=>{Ge(t)})})}function He(e){E.textContent=e.target.value,v=e.target.value}function Je(e){S.textContent=e.target.value,e.target.value}function Ke(e){if(e.preventDefault(),!u){x("Please select a rating");return}if(!v){x("Please enter a email");return}if(!Ye(v)){x("please enter a valid email address");return}let t={id:I,rate:Number(u),email:v};Be(t).then(s=>{je("Success"),te(),ee()}).catch(s=>(console.log(s),x("err")))}const Ye=e=>String(e).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);function ee(e){te(),V(I).then(t=>{z(t,Z),se()}).catch(t=>{console.log(t.message)})}function te(){u=0,v=""}let w,b,A,l,h=document.querySelector("."+J);h&&h.addEventListener("click",ze);const P=document.querySelector(be);P&&P.addEventListener("click",Qe);async function Qe(e){e.preventDefault();const t=e.target;if(t.classList.contains(ve)&&(t.nodeName!=="BUTTON"?l=t.closest("button").dataset.id:l=t.dataset.id,!!l))try{const s=await V(l);s&&(z(s,h),se())}catch(s){console.log(s.message)}}function _(e){window.removeEventListener("keydown",ae),h.classList.remove(K)}function se(){h.classList.add(K),window.addEventListener("keydown",ae),w=document.querySelector(ge),w&&w.addEventListener("click",_),b=document.querySelector(he),b&&b.addEventListener("click",Ve),Se(l,b);const e=document.querySelector(xe);Re(e),A=document.querySelector(ye),A&&A.addEventListener("click",We)}function ae(e){e.code===fe&&_()}function ze(e){e.currentTarget===e.target&&_()}function Ve(e){Le(l,b)}function We(e){Pe(e,l)}const U=[{url:"https://www.facebook.com/goITclub/",id:"#facebook",label:"facebook icon",hrefTag:"icon-facebook"},{url:"https://www.instagram.com/goitclub/",id:"#instagram",label:"instagram icon",hrefTag:"icon-instagram"},{url:"https://www.youtube.com/c/GoIT",id:"#youtube",label:"youtube icon",hrefTag:"icon-youtube"}];function Ze(e,t=[]){const{iconURL:s,iconContainerClass:a,iconLinkClass:n,iconClass:r}=e;return t.reduce((c,{url:p,id:f,label:L,hrefTag:g})=>c+`
        <li class="${a}">
