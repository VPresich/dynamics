var T=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var B=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),$=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},D=(e,t,s,a)=>(T(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s);var u=(e,t,s)=>(T(e,t,"access private method"),s);import{i as J}from"./vendor-32231325.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerpolicy&&(n.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?n.credentials="include":r.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const I="https://energyflow.b.goit.study/api/";var y,i,d;class _{constructor(t){$(this,i);$(this,y,"");D(this,y,t)}async objectGetRequest(t){return u(this,i,d).call(this,t)}async objectCreateRequest(t,s){return u(this,i,d).call(this,t,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(t,s){return u(this,i,d).call(this,`${t}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(t,s){return u(this,i,d).call(this,`${t}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectPatchRequest(t,s){const{id:a,...r}=s;return u(this,i,d).call(this,`${t}/${a}/rating`,{method:"PATCH",body:JSON.stringify(r),headers:{"Content-Type":"application/json"}})}}y=new WeakMap,i=new WeakSet,d=async function(t,s={}){try{const a=await fetch(B(this,y)+t,s);if(!a.ok)throw new Error(`HTTP error, status: ${a.status}`);return a.json()}catch(a){console.log(a.message)}};const ae=document.querySelector(".js-quote"),F="quote",j="date",re=new _(I);ne();async function ne(){try{const{quote:e,author:t}=await oe();ie({quote:e,author:t})}catch(e){console.error("Error fetching or displaying quote:",e)}}async function oe(){const e=localStorage.getItem(j),t=localStorage.getItem(F),a=new Date().toISOString().split("T")[0];if(e===a&&t){const n=JSON.parse(t);if(n.quote&&n.author)return n}const r=await ce();return localStorage.setItem(j,a),localStorage.setItem(F,JSON.stringify(r)),r}async function ce(){const{quote:e,author:t}=await re.objectGetRequest("quote");return{quote:e,author:t}}function ie({quote:e,author:t}){ae.innerHTML=`
    <p class="quote-text">${e}</p>
    <h3 class="quote-author">${t}</h3>
  `}const o="/dynamics/assets/symbols-4ad092cf.svg";function rt(e=[],t){return e.reduce((s,{_id:a,bodyPart:r,equipment:n,time:c,target:m,burnedCalories:p,gifUrl:R,name:f,filter:M,popularity:N,rating:se})=>s+`
      ...
      </svg>`;e.insertAdjacentHTML("beforeend",s)},Le="exercises",Re=".rating-form-send-btn",Te=".stars-container",$e=".star-btn.rating-form-btn",we=".rating-form-email-input",Ae=".rating-form-comment";function ke(e={}){return`
  ...
  >
    ...
    >
      ...
      `}const W=(e,t)=>{const s=qe(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)};async function Ie(e){const t=new _(I);try{return await t.objectPatchRequest(Le,e)}catch(s){throw s}}const _e="/dynamics/assets/bi-x-octagon-73f29380.svg",Me="/dynamics/assets/bi_check-45de7d45.svg";function x(e){J.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#fc5a5a",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${_e}`,iconColor:"#fafafb"})}function Ne(e){J.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#82C43C",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${Me}`,iconColor:"#fafafb"})}let O,w,S,E,q,l=0,b,Be=document.querySelector("."+K);const P=document.querySelector(Y);function De(e,t){e.preventDefault(),t&&(q=t,Oe({exerciseRating:l},Be),O=document.querySelector(Te),W({exerciseRating:l},O),Fe())}function Fe(){w=document.querySelector(Re),w&&w.addEventListener("click",Ge),S=document.querySelector(we),S&&S.addEventListener("input",Pe),E=document.querySelector(Ae),E&&E.addEventListener("input",Ue),Z()}function je(e){l=e.getAttribute("data-starnumber"),W({exerciseRating:l},O),Z()}function Z(){const e=document.querySelectorAll($e);e&&e.forEach(function(t){t.addEventListener("click",()=>{je(t)})})}function Pe(e){S.textContent=e.target.value,b=e.target.value}function Ue(e){E.textContent=e.target.value,e.target.value}function Ge(e){if(e.preventDefault(),!l){x("Please select a rating");return}if(!b){x("Please enter a email");return}if(!He(b)){x("please enter a valid email address");return}let t={id:q,rate:Number(l),email:b};Ie(t).then(s=>{Ne("Success"),Je(),L(),console.log(s),P&&P.querySelectorAll(`button,[data-id="${q}"]`)[0].click()}).catch(s=>(console.log(s),x("err")))}const He=e=>String(e).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);function Je(){l=0,b=""}let A,g,k,h,v=document.querySelector("."+K);v&&v.addEventListener("click",Qe);const U=document.querySelector(Y);U&&U.addEventListener("click",Ke);async function Ke(e){e.preventDefault();const t=e.target;if(t.classList.contains(me)){h=t.dataset.id;try{const s=await ve(h);s&&(he(s,v),Ye())}catch(s){console.log(s.message)}}}function L(e){window.removeEventListener("keydown",X),v.classList.remove(Q)}function Ye(){v.classList.add(Q),window.addEventListener("keydown",X),A=document.querySelector(de),A&&A.addEventListener("click",L),g=document.querySelector(pe),g&&g.addEventListener("click",ze),ye(h,g);const e=document.querySelector(ge);Ce(e),k=document.querySelector(fe),k&&k.addEventListener("click",Ve)}function X(e){e.code===ue&&L()}function Qe(e){e.currentTarget===e.target&&L()}function ze(e){Se(h,g)}function Ve(e){De(e,h)}const G=[{url:"https://www.facebook.com/goITclub/",id:"#facebook",label:"facebook icon",hrefTag:"icon-facebook"},{url:"https://www.instagram.com/goitclub/",id:"#instagram",label:"instagram icon",hrefTag:"icon-instagram"},{url:"https://www.youtube.com/c/GoIT",id:"#youtube",label:"youtube icon",hrefTag:"icon-youtube"}];function We(e,t=[]){const{iconURL:s,iconContainerClass:a,iconLinkClass:r,iconClass:n}=e;return t.reduce((c,{url:m,id:p,label:R,hrefTag:f})=>c+`
        <li class="${a}">
            <a class="${r}" target="_blank" rel="noopener" href="${m}">
            <svg class="${n}" aria-label="${R}" id=${p}>
                <use href="${s}#${f}"></use>
            </svg>
            </a>
        </li>
...
//# sourceMappingURL=handle-menu-buttons-b47ed98d.js.map
