var V=Object.defineProperty;var Z=(t,e,s)=>e in t?V(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var h=(t,e,s)=>(Z(t,typeof e!="symbol"?e+"":e,s),s),k=(t,e,s)=>{if(!e.has(t))throw TypeError("Cannot "+s)};var c=(t,e,s)=>(k(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,s)},y=(t,e,s,r)=>(k(t,e,"write to private field"),r?r.call(t,s):e.set(t,s),s);var d=(t,e,s)=>(k(t,e,"access private method"),s);/* empty css                      */import{i as ee}from"./assets/vendor-32231325.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerpolicy&&(i.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?i.credentials="include":a.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const te="Muscles",j="filters",M="exercises",C="https://energyflow.b.goit.study/api/";var b,u,v;class T{constructor(e){l(this,u);l(this,b,"");y(this,b,e)}async objectGetRequest(e){return d(this,u,v).call(this,e)}async objectCreateRequest(e,s){return d(this,u,v).call(this,e,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(e,s){return d(this,u,v).call(this,`${e}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(e,s){return d(this,u,v).call(this,`${e}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}}b=new WeakMap,u=new WeakSet,v=async function(e,s={}){try{const r=await fetch(c(this,b)+e,s);if(!r.ok)throw new Error(`HTTP error, status: ${r.status}`);return r.json()}catch(r){console.log(r.message)}};const se=t=>{let e=8;const s=window.innerWidth;if(s>=1440)e=12;else if(s>=768)switch(t){case j:e=12;break;case M:e=6;break;default:e=8;break}return e},F=(t,e={},s=1,r="")=>{let a={};return e&&(a={...e}),t===M&&r&&(a={...a,keyword:r}),a={...a,page:s,limit:se(j)},`${t}?${new URLSearchParams(a).toString()}`};async function ae(t,e){const s=new T(C),r=F("filters",t,e);try{return await s.objectGetRequest(r)}catch{}}function re(t=[]){return t.reduce((e,{imgUrl:s,name:r,filter:a})=>e+`
      ...
      `,"")}const G=(t,e,s)=>{e.innerHTML="",t.length||console.log("Sorry, there are no data matching your search query. Please, try again!");const r=s(t);e.innerHTML="",e.insertAdjacentHTML("beforeend",r),e.classList.remove("visually-hidden")},ie=(t,e)=>G(e,t,re),ce="/dynamics/assets/bi-x-octagon-73f29380.svg";function ne(t){ee.show({message:t,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#fc5a5a",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${ce}`,iconColor:"#fafafb"})}async function oe(t={},e=1,s=""){const r=new T(C),a=F(M,t,e,s);try{return await r.objectGetRequest(a)}catch{}}function le(t=[]){return t.reduce((e,{_id:s,bodyPart:r,equipment:a,time:i,target:o,burnedCalories:q,gifUrl:B,name:A,filter:H,popularity:I,rating:$})=>e+`
      ...
      `,"")}const de=(t,e)=>G(e,t,le);var n,L,f,p,S,_,w,D;class ue{constructor({galleryHandle:e,filter:s,dotsSelector:r,dotDefaultClass:a,dotActiveClass:i}){l(this,S);l(this,w);h(this,"currentPage",1);h(this,"totalPages",0);l(this,n,void 0);l(this,L,10);l(this,f,"pagination-dot");l(this,p,"active-paggination-dot");h(this,"galleryHandle");h(this,"filter");this.galleryHandle=e,this.filter=s,y(this,p,i),y(this,f,a),y(this,n,document.querySelector(r)),c(this,n).addEventListener("click",this.onDotsClick.bind(this))}init(e,s,r=0){this.galleryHandle=e,this.totalPages=r>c(this,L)?c(this,L):r,this.filter=s,d(this,S,_).call(this)}reset(e,s,r=1,a=0){this.galleryHandle=e,this.totalPages=a,this.currentPage=r,this.filter=s,d(this,w,D).call(this)}destroy(){c(this,n).removeEventListener("click",this.onDotsClick.bind(this)),d(this,w,D).call(this)}async updateGallery(){try{await this.galleryHandle(this.filter,this.currentPage,12)}catch(e){console.log(e.message)}}onDotsClick(e){const s=e.target;if(!s.classList.contains(c(this,f)))return;const r=parseInt(s.dataset.ind,10);this.currentPage=r,this.updateDisplayDots(),this.updateGallery()}updateDisplayDots(){const e=c(this,n).querySelectorAll("li");e.forEach(s=>{s.classList.remove(c(this,p))}),e[this.currentPage-1].classList.add(c(this,p))}}n=new WeakMap,L=new WeakMap,f=new WeakMap,p=new WeakMap,S=new WeakSet,_=function(){c(this,n).innerHTML="";let e="";for(let s=0;s<this.totalPages;s+=1)e+=`
       <li class="${c(this,f)}" data-ind="${s+1}">${s+1}</li>
      `;c(this,n).innerHTML=e,c(this,n).children[this.currentPage-1].classList.add(c(this,p))},w=new WeakSet,D=function(){c(this,n).innerHTML=""};const Q=t=>{t.innerHTML="",t.classList.add("visually-hidden")},P="filter-button-active";let g={};const Y=document.querySelector(".filters-buttons"),O=document.querySelector(".exercise-filters-list"),K=document.querySelector(".exercises-gallery");Y.addEventListener("click",pe);O.addEventListener("click",ge);const m=new ue({galleryHandle:x,dotsSelector:".pagination-dots",dotDefaultClass:"pagination-dot",dotActiveClass:"active-pagination-dot"});function pe(t){if(t.target.tagName!=="BUTTON")return;t.preventDefault();const e=t.target.dataset.filter;m.reset(x,e,1,0),x({filter:e}),me(t.target)}function x(t={filter:te}){ae(t,m.currentPage).then(e=>{const s=e.results;Q(K),ie(O,s),m.init(x,t,e.totalPages)}).catch(e=>{console.log(e.message)})}function ge(t){t.preventDefault(),t.target;const e=t.target.closest("li");if(!e)return;const s={},r=e.querySelector(".filter-name"),a=e.querySelector(".filter-type");if(a&&a){const i=r.textContent.toLowerCase(),o=a.textContent.toLowerCase();if(o==="")return;s[o]=i}m.reset(R,s,1,0),R(s)}function R(t){oe(t,m.currentPage).then(e=>{Q(O),de(K,e.results),m.init(R,t,e.totalPages)}).catch(e=>{console.log(e.message),ne(`Error fetching images: ${e.message}`)})}function fe(){g=Y.querySelector("BUTTON"),g&&g.classList.add(P)}function me(t){g&&g.classList.remove(P),t&&t.classList.add(P),g=t}fe();x();const he="Escape",W="modal-backdrop",ye=".exercise-close-btn",ve=".exercises-gallery",xe="ex-card-start-btn",J="is-open";function be(t={}){const{_id:e,bodyPart:s,equipment:r,time:a,target:i,burnedCalories:o,gifUrl:q,name:B,filter:A,popularity:H,rating:I,description:$}=t;return`
