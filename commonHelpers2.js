var ce=Object.defineProperty;var le=(t,e,s)=>e in t?ce(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var h=(t,e,s)=>(le(t,typeof e!="symbol"?e+"":e,s),s),O=(t,e,s)=>{if(!e.has(t))throw TypeError("Cannot "+s)};var n=(t,e,s)=>(O(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,s)},v=(t,e,s,r)=>(O(t,e,"write to private field"),r?r.call(t,s):e.set(t,s),s);var d=(t,e,s)=>(O(t,e,"access private method"),s);import"./assets/styles-898b8e78.js";import{i as z}from"./assets/vendor-0a7943b3.js";const R="https://energyflow.b.goit.study/api/";var C,p,b;class M{constructor(e){l(this,p);l(this,C,"");v(this,C,e)}async objectGetRequest(e){return d(this,p,b).call(this,e)}async objectCreateRequest(e,s){return d(this,p,b).call(this,e,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(e,s){return d(this,p,b).call(this,`${e}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(e,s){return d(this,p,b).call(this,`${e}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}}C=new WeakMap,p=new WeakSet,b=async function(e,s={}){try{const r=await fetch(n(this,C)+e,s);if(!r.ok)throw new Error(`HTTP error, status: ${r.status}`);return r.json()}catch(r){console.log(r.message)}};const ue=document.querySelector(".js-quote"),Y="quote",J="date",de=new M(R);pe();async function pe(){try{const{quote:t,author:e}=await fe();he({quote:t,author:e})}catch(t){console.error("Error fetching or displaying quote:",t)}}async function fe(){const t=localStorage.getItem(J),e=localStorage.getItem(Y),r=new Date().toISOString().split("T")[0];if(t===r&&e){const i=JSON.parse(e);if(i.quote&&i.author)return i}const a=await ge();return localStorage.setItem(J,r),localStorage.setItem(Y,JSON.stringify(a)),a}async function ge(){const{quote:t,author:e}=await de.objectGetRequest("quote");return{quote:t,author:e}}function he({quote:t,author:e}){ue.innerHTML=`
  ...
  `}const me="Muscles",V="filters",F="exercises",ye=t=>{let e=8;const s=window.innerWidth;if(s>=1440)e=12;else if(s>=768)switch(t){case V:e=12;break;case F:e=6;break;default:e=8;break}return e},X=(t,e={},s=1,r="")=>{let a={};return e&&(a={...e}),t===F&&r&&(a={...a,keyword:r}),a={...a,page:s,limit:ye(V)},`${t}?${new URLSearchParams(a).toString()}`};async function xe(t,e){const s=new M(R),r=X("filters",t,e);try{return await s.objectGetRequest(r)}catch{}}function ve(t=[]){return t.reduce((e,{imgUrl:s,name:r,filter:a})=>e+`
          ...
          <div class="ex-card-name-container">
            <div class="runner-icon-container">
              <svg class="runner-icon" width="24" height="24" aria-label="runner icon">
                <use href="${w}#icon-running-man"></use>
              </svg>
            </div>
      ...
      `,"")}const ee=(t,e)=>_(e,t,$e);var c,E,y,f,P,te,T,H;class qe{constructor({galleryHandle:e,filter:s,dotsSelector:r,dotDefaultClass:a,dotActiveClass:i}){l(this,P);l(this,T);h(this,"currentPage",1);h(this,"totalPages",0);l(this,c,void 0);l(this,E,10);l(this,y,"pagination-dot");l(this,f,"active-paggination-dot");h(this,"galleryHandle");h(this,"filter",{filter:""});h(this,"keyWord","");this.galleryHandle=e,this.filter=s,v(this,f,i),v(this,y,a),v(this,c,document.querySelector(r)),n(this,c).addEventListener("click",this.onDotsClick.bind(this))}init(e,s,r=0){this.galleryHandle=e,this.totalPages=r>n(this,E)?n(this,E):r,this.filter=s,d(this,P,te).call(this)}reset(e,s,r=1,a="",i=0){this.galleryHandle=e,this.totalPages=i,this.currentPage=r,this.filter=s,this.keyWord=a,d(this,T,H).call(this)}destroy(){n(this,c).removeEventListener("click",this.onDotsClick.bind(this)),d(this,T,H).call(this)}async updateGallery(){try{await this.galleryHandle(this.filter,this.currentPage,this.keyWord,this.totalPages)}catch(e){console.log(e.message)}}onDotsClick(e){const s=e.target;if(!s.classList.contains(n(this,y)))return;const r=parseInt(s.dataset.ind,10);this.currentPage=r,this.updateDisplayDots(),this.updateGallery()}updateDisplayDots(){const e=n(this,c).querySelectorAll("li");e.forEach(s=>{s.classList.remove(n(this,f))}),e[this.currentPage-1].classList.add(n(this,f))}}c=new WeakMap,E=new WeakMap,y=new WeakMap,f=new WeakMap,P=new WeakSet,te=function(){n(this,c).innerHTML="";let e="";for(let s=0;s<this.totalPages;s+=1)e+=`
       <li class="${n(this,y)}" data-ind="${s+1}">${s+1}</li>
      `;n(this,c).innerHTML=e,n(this,c).children[this.currentPage-1].classList.add(n(this,f))},T=new WeakSet,H=function(){n(this,c).innerHTML=""};const I=t=>{t.innerHTML="",t.classList.add("visually-hidden")};function De(t){return`
  ...
  `}const U="filter-button-active";let m={};const D=document.querySelector(".exercise-filter-title"),se=document.querySelector(".filters-buttons"),G=document.querySelector(".exercise-filters-list"),L=document.querySelector(".exercises-gallery"),N=document.querySelector(".form-for-searching-input"),Pe=document.querySelector(".searching-input");se.addEventListener("click",Re);G.addEventListener("click",Me);N.addEventListener("submit",He);const g=new qe({galleryHandle:S,dotsSelector:".pagination-dots",dotDefaultClass:"pagination-dot",dotActiveClass:"active-pagination-dot"});function Re(t){if(t.target.tagName!=="BUTTON")return;t.preventDefault();const e=t.target.dataset.filter;N.classList.add("visually-hidden"),g.reset(S,e,1,0),je(),S({filter:e}),Be(t.target)}function S(t={filter:me}){xe(t,g.currentPage).then(e=>{const s=e.results;I(L),Ce(G,s),g.init(S,t,e.totalPages)}).catch(e=>{console.log(e.message)})}function Me(t){t.preventDefault(),t.target;const e=t.target.closest("li");if(!e)return;const s={},r=e.querySelector(".filter-name"),a=e.querySelector(".filter-type");if(N.classList.remove("visually-hidden"),a&&a){const i=r.textContent.toLowerCase(),u=a.textContent.toLowerCase();if(u==="")return;s[u]=i}Fe(r.textContent),g.reset(j,s,1,0),j(s)}function j(t){Z(t,g.currentPage).then(e=>{I(G),ee(L,e.results),g.init(j,t,e.totalPages)}).catch(e=>{console.log(e.message),A(`Error fetching images: ${e.message}`)})}function Ie(){m=se.querySelector("BUTTON"),m&&m.classList.add(U)}function Be(t){m&&m.classList.remove(U),t&&t.classList.add(U),m=t}function Oe(){const t=document.querySelector(".filter-button-active"),e=document.querySelector(".chapter-text"),s={};return s[t.dataset.filter.toLowerCase()]=e.textContent.toLowerCase(),s}function Ae(){return Pe.value.trim().toLowerCase()}function He(t){t.preventDefault();const e=Ae(),s=Oe();Ue(s,e)}function Ue(t,e){Z(t,g.currentPage,e).then(s=>{if(!s.results){console.log(s.results),_([],L,De);return}return s}).then(s=>{I(L),ee(L,s.results)}).catch(s=>{console.log(s.message)})}function je(){D.textContent.indexOf("/")!==-1&&(D.textContent=D.textContent.split("/")[0])}function Fe(t){const e=` / 
  <span class="chapter-text">${t}</span>`;D.insertAdjacentHTML("beforeend",e)}Ie();S();const _e="Escape",re="modal-backdrop",Ge=".exercise-close-btn",Ne=".exercises-gallery",We="ex-card-start-btn",ae="is-open";function Qe(t={}){const{_id:e,bodyPart:s,equipment:r,time:a,target:i,burnedCalories:u,gifUrl:x,name:k,filter:$,popularity:q,rating:Q,description:B}=t;return`
