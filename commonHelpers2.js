var oe=Object.defineProperty;var ce=(t,e,s)=>e in t?oe(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var h=(t,e,s)=>(ce(t,typeof e!="symbol"?e+"":e,s),s),R=(t,e,s)=>{if(!e.has(t))throw TypeError("Cannot "+s)};var i=(t,e,s)=>(R(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,s)},x=(t,e,s,r)=>(R(t,e,"write to private field"),r?r.call(t,s):e.set(t,s),s);var u=(t,e,s)=>(R(t,e,"access private method"),s);import"./assets/styles-6d30f877.js";import{i as J}from"./assets/vendor-0a7943b3.js";const q="https://energyflow.b.goit.study/api/";var L,d,v;class T{constructor(e){l(this,d);l(this,L,"");x(this,L,e)}async objectGetRequest(e){return u(this,d,v).call(this,e)}async objectCreateRequest(e,s){return u(this,d,v).call(this,e,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(e,s){return u(this,d,v).call(this,`${e}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(e,s){return u(this,d,v).call(this,`${e}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}}L=new WeakMap,d=new WeakSet,v=async function(e,s={}){try{const r=await fetch(i(this,L)+e,s);if(!r.ok)throw new Error(`HTTP error, status: ${r.status}`);return r.json()}catch(r){console.log(r.message)}};const le=document.querySelector(".js-quote"),Q="quote",Y="date",ue=new T(q);de();async function de(){try{const{quote:t,author:e}=await pe();fe({quote:t,author:e})}catch(t){console.error("Error fetching or displaying quote:",t)}}async function pe(){const t=localStorage.getItem(Y),e=localStorage.getItem(Q),r=new Date().toISOString().split("T")[0];if(t===r&&e){const n=JSON.parse(e);if(n.quote&&n.author)return n}const a=await ge();return localStorage.setItem(Y,r),localStorage.setItem(Q,JSON.stringify(a)),a}async function ge(){const{quote:t,author:e}=await ue.objectGetRequest("quote");return{quote:t,author:e}}function fe({quote:t,author:e}){le.innerHTML=`
  ...
  `}const he="Muscles",K="filters",I="exercises",me=t=>{let e=8;const s=window.innerWidth;if(s>=1440)e=12;else if(s>=768)switch(t){case K:e=12;break;case I:e=6;break;default:e=8;break}return e},z=(t,e={},s=1,r="")=>{let a={};return e&&(a={...e}),t===I&&r&&(a={...a,keyword:r}),a={...a,page:s,limit:me(K)},`${t}?${new URLSearchParams(a).toString()}`};async function ye(t,e){const s=new T(q),r=z("filters",t,e);try{return await s.objectGetRequest(r)}catch{}}function xe(t=[]){return t.reduce((e,{imgUrl:s,name:r,filter:a})=>e+`
      ...
      `,"")}const Z=(t,e)=>A(e,t,Se);var c,S,y,p,k,ee,E,M;class Ee{constructor({galleryHandle:e,filter:s,dotsSelector:r,dotDefaultClass:a,dotActiveClass:n}){l(this,k);l(this,E);h(this,"currentPage",1);h(this,"totalPages",0);l(this,c,void 0);l(this,S,10);l(this,y,"pagination-dot");l(this,p,"active-paggination-dot");h(this,"galleryHandle");h(this,"filter",{filter:""});h(this,"keyWord","");this.galleryHandle=e,this.filter=s,x(this,p,n),x(this,y,a),x(this,c,document.querySelector(r)),i(this,c).addEventListener("click",this.onDotsClick.bind(this))}init(e,s,r=0){this.galleryHandle=e,this.totalPages=r>i(this,S)?i(this,S):r,this.filter=s,u(this,k,ee).call(this)}reset(e,s,r=1,a="",n=0){this.galleryHandle=e,this.totalPages=n,this.currentPage=r,this.filter=s,this.keyWord=a,u(this,E,M).call(this)}destroy(){i(this,c).removeEventListener("click",this.onDotsClick.bind(this)),u(this,E,M).call(this)}async updateGallery(){try{await this.galleryHandle(this.filter,this.currentPage,this.keyWord,this.totalPages)}catch(e){console.log(e.message)}}onDotsClick(e){const s=e.target;if(!s.classList.contains(i(this,y)))return;const r=parseInt(s.dataset.ind,10);this.currentPage=r,this.updateDisplayDots(),this.updateGallery()}updateDisplayDots(){const e=i(this,c).querySelectorAll("li");e.forEach(s=>{s.classList.remove(i(this,p))}),e[this.currentPage-1].classList.add(i(this,p))}}c=new WeakMap,S=new WeakMap,y=new WeakMap,p=new WeakMap,k=new WeakSet,ee=function(){i(this,c).innerHTML="";let e="";for(let s=0;s<this.totalPages;s+=1)e+=`
  ...
  `}const O="filter-button-active";let m={};const C=document.querySelector(".exercise-filter-title"),te=document.querySelector(".filters-buttons"),B=document.querySelector(".exercise-filters-list"),b=document.querySelector(".exercises-gallery"),U=document.querySelector(".form-for-searching-input"),ke=document.querySelector(".searching-input");te.addEventListener("click",qe);B.addEventListener("click",Te);U.addEventListener("submit",Me);const g=new Ee({galleryHandle:w,dotsSelector:".pagination-dots",dotDefaultClass:"pagination-dot",dotActiveClass:"active-pagination-dot"});function qe(t){if(t.target.tagName!=="BUTTON")return;t.preventDefault();const e=t.target.dataset.filter;U.classList.add("visually-hidden"),g.reset(w,e,1,0),He(),w({filter:e}),De(t.target)}function w(t={filter:he}){ye(t,g.currentPage).then(e=>{const s=e.results;$(b),ve(B,s),g.init(w,t,e.totalPages)}).catch(e=>{console.log(e.message)})}function Te(t){t.preventDefault(),t.target;const e=t.target.closest("li");if(!e)return;const s={},r=e.querySelector(".filter-name"),a=e.querySelector(".filter-type");if(U.classList.remove("visually-hidden"),a&&a){const n=r.textContent.toLowerCase(),f=a.textContent.toLowerCase();if(f==="")return;s[f]=n}Ie(r.textContent),g.reset(H,s,1,0),H(s)}function H(t){X(t,g.currentPage).then(e=>{$(B),Z(b,e.results),g.init(H,t,e.totalPages)}).catch(e=>{console.log(e.message),V(`Error fetching images: ${e.message}`)})}function $e(){m=te.querySelector("BUTTON"),m&&m.classList.add(O)}function De(t){m&&m.classList.remove(O),t&&t.classList.add(O),m=t}function Pe(){const t=document.querySelector(".filter-button-active"),e=document.querySelector(".chapter-text"),s={};return s[t.dataset.filter.toLowerCase()]=e.textContent.toLowerCase(),s}function Re(){return ke.value.trim().toLowerCase()}function Me(t){t.preventDefault();const e=Re(),s=Pe();Oe(s,e)}function Oe(t,e){X(t,g.currentPage,e).then(s=>{if(!s.results){console.log(s.results),A([],b,Ce);return}return s}).then(s=>{$(b),Z(b,s.results)}).catch(s=>{console.log(s.message)})}function He(){C.textContent.indexOf("/")!==-1&&(C.textContent=C.textContent.split("/")[0])}function Ie(t){const e=`/ 
  <span class="chapter-text">${t}</span>`;C.insertAdjacentHTML("beforeend",e)}$e();w();const Ae="Escape",se="modal-backdrop",Be=".exercise-close-btn",Ue=".exercises-gallery",je="ex-card-start-btn",re="is-open";function Fe(t={}){const{_id:e,bodyPart:s,equipment:r,time:a,target:n,burnedCalories:f,gifUrl:D,name:F,filter:N,popularity:_,rating:G,description:P}=t;return`
