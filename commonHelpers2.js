var ce=Object.defineProperty;var le=(t,e,s)=>e in t?ce(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var h=(t,e,s)=>(le(t,typeof e!="symbol"?e+"":e,s),s),R=(t,e,s)=>{if(!e.has(t))throw TypeError("Cannot "+s)};var i=(t,e,s)=>(R(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,s)},x=(t,e,s,r)=>(R(t,e,"write to private field"),r?r.call(t,s):e.set(t,s),s);var d=(t,e,s)=>(R(t,e,"access private method"),s);import"./assets/styles-4152d9a7.js";import{i as K}from"./assets/vendor-0a7943b3.js";const k="https://energyflow.b.goit.study/api/";var L,u,v;class q{constructor(e){l(this,u);l(this,L,"");x(this,L,e)}async objectGetRequest(e){return d(this,u,v).call(this,e)}async objectCreateRequest(e,s){return d(this,u,v).call(this,e,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(e,s){return d(this,u,v).call(this,`${e}/${s}`,{method:"DELETE"})}async ojectUpdateRequest(e,s){return d(this,u,v).call(this,`${e}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}}L=new WeakMap,u=new WeakSet,v=async function(e,s={}){try{const r=await fetch(i(this,L)+e,s);if(!r.ok)throw new Error(`HTTP error, status: ${r.status}`);return r.json()}catch(r){console.log(r.message)}};const de=document.querySelector(".js-quote"),Q="quote",Y="date",ue=new q(k);pe();async function pe(){try{const{quote:t,author:e}=await ge();he({quote:t,author:e})}catch(t){console.error("Error fetching or displaying quote:",t)}}async function ge(){const t=localStorage.getItem(Y),e=localStorage.getItem(Q),r=new Date().toISOString().split("T")[0];if(t===r&&e){const n=JSON.parse(e);if(n.quote&&n.author)return n}const a=await fe();return localStorage.setItem(Y,r),localStorage.setItem(Q,JSON.stringify(a)),a}async function fe(){const{quote:t,author:e}=await ue.objectGetRequest("quote");return{quote:t,author:e}}function he({quote:t,author:e}){de.innerHTML=`
  ...
  `}const me="Muscles",z="filters",I="exercises",ye=t=>{let e=8;const s=window.innerWidth;if(s>=1440)e=12;else if(s>=768)switch(t){case z:e=12;break;case I:e=6;break;default:e=8;break}return e},V=(t,e={},s=1,r="")=>{let a={};return e&&(a={...e}),t===I&&r&&(a={...a,keyword:r}),a={...a,page:s,limit:ye(z)},`${t}?${new URLSearchParams(a).toString()}`};async function xe(t,e){const s=new q(k),r=V("filters",t,e);try{return await s.objectGetRequest(r)}catch{}}function ve(t=[]){return t.reduce((e,{imgUrl:s,name:r,filter:a})=>e+`
      ...
      `,"")}const ee=(t,e)=>A(e,t,qe);var c,S,y,p,T,te,E,M;class $e{constructor({galleryHandle:e,filter:s,dotsSelector:r,dotDefaultClass:a,dotActiveClass:n}){l(this,T);l(this,E);h(this,"currentPage",1);h(this,"totalPages",0);l(this,c,void 0);l(this,S,10);l(this,y,"pagination-dot");l(this,p,"active-paggination-dot");h(this,"galleryHandle");h(this,"filter",{filter:""});h(this,"keyWord","");this.galleryHandle=e,this.filter=s,x(this,p,n),x(this,y,a),x(this,c,document.querySelector(r)),i(this,c).addEventListener("click",this.onDotsClick.bind(this))}init(e,s,r=0){this.galleryHandle=e,this.totalPages=r>i(this,S)?i(this,S):r,this.filter=s,d(this,T,te).call(this)}reset(e,s,r=1,a="",n=0){this.galleryHandle=e,this.totalPages=n,this.currentPage=r,this.filter=s,this.keyWord=a,d(this,E,M).call(this)}destroy(){i(this,c).removeEventListener("click",this.onDotsClick.bind(this)),d(this,E,M).call(this)}async updateGallery(){try{await this.galleryHandle(this.filter,this.currentPage,this.keyWord,this.totalPages)}catch(e){console.log(e.message)}}onDotsClick(e){const s=e.target;if(!s.classList.contains(i(this,y)))return;const r=parseInt(s.dataset.ind,10);this.currentPage=r,this.updateDisplayDots(),this.updateGallery()}updateDisplayDots(){const e=i(this,c).querySelectorAll("li");e.forEach(s=>{s.classList.remove(i(this,p))}),e[this.currentPage-1].classList.add(i(this,p))}}c=new WeakMap,S=new WeakMap,y=new WeakMap,p=new WeakMap,T=new WeakSet,te=function(){i(this,c).innerHTML="";let e="";for(let s=0;s<this.totalPages;s+=1)e+=`
  ...
  `}const O="filter-button-active";let m={};const C=document.querySelector(".exercise-filter-title"),se=document.querySelector(".filters-buttons"),U=document.querySelector(".exercise-filters-list"),b=document.querySelector(".exercises-gallery"),j=document.querySelector(".form-for-searching-input"),Pe=document.querySelector(".searching-input");se.addEventListener("click",Re);U.addEventListener("click",Be);j.addEventListener("submit",Ae);const g=new $e({galleryHandle:w,dotsSelector:".pagination-dots",dotDefaultClass:"pagination-dot",dotActiveClass:"active-pagination-dot"});function Re(t){if(t.target.tagName!=="BUTTON")return;t.preventDefault();const e=t.target.dataset.filter;j.classList.add("visually-hidden"),g.reset(w,e,1,0),je(),w({filter:e}),Oe(t.target)}function w(t={filter:me}){xe(t,g.currentPage).then(e=>{const s=e.results;$(b),Ee(U,s),g.init(w,t,e.totalPages)}).catch(e=>{console.log(e.message)})}function Be(t){t.preventDefault(),t.target;const e=t.target.closest("li");if(!e)return;const s={},r=e.querySelector(".filter-name"),a=e.querySelector(".filter-type");if(j.classList.remove("visually-hidden"),a&&a){const n=r.textContent.toLowerCase(),f=a.textContent.toLowerCase();if(f==="")return;s[f]=n}Fe(r.textContent),g.reset(H,s,1,0),H(s)}function H(t){Z(t,g.currentPage).then(e=>{$(U),ee(b,e.results),g.init(H,t,e.totalPages)}).catch(e=>{console.log(e.message),X(`Error fetching images: ${e.message}`)})}function Me(){m=se.querySelector("BUTTON"),m&&m.classList.add(O)}function Oe(t){m&&m.classList.remove(O),t&&t.classList.add(O),m=t}function He(){const t=document.querySelector(".filter-button-active"),e=document.querySelector(".chapter-text"),s={};return s[t.dataset.filter.toLowerCase()]=e.textContent.toLowerCase(),s}function Ie(){return Pe.value.trim().toLowerCase()}function Ae(t){t.preventDefault();const e=Ie(),s=He();Ue(s,e)}function Ue(t,e){Z(t,g.currentPage,e).then(s=>{if(!s.results){console.log(s.results),A([],b,De);return}return s}).then(s=>{$(b),ee(b,s.results)}).catch(s=>{console.log(s.message)})}function je(){C.textContent.indexOf("/")!==-1&&(C.textContent=C.textContent.split("/")[0])}function Fe(t){const e=` / 
